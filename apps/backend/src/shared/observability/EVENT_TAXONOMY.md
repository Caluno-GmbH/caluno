...
Capture is fire-and-forget. Missing `POSTHOG_API_KEY` or an unloaded daily HMAC secret is a no-op. The HMAC secret is generated by the backend, stored in Postgres, and rotated on the Europe/Berlin calendar date.
